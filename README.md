...
<p align="justify"> Taking into account that in many cases, behind data, there are people, the increase in the amount of data has come with new challenges for Data Scientists and organizations, such as ethical questions. For that reason, one must be aware of the ethical implications of data processing by adhering to and following a global ethical code and laws such as the General Data Protection Regulation (GDPR) to protect the rights and freedom of individuals. Failure to comply with ethical principles and regulations may result in legal action and loss of reputation, which could harm both individuals and organizations. </p>
